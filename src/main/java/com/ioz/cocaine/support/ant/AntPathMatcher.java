package com.ioz.cocaine.support.ant;
...
public class AntPathMatcher implements PathMatcher {
    ...
    protected boolean doMatch(final String pattern, final String path,
        ...
        final String[] patternDirs = new StringTokenizer(pattern, pathSeparator)
                .setIgnoreEmptyTokens(true).getTokenArray();
        final String[] pathDirs = new StringTokenizer(path, pathSeparator)
                .setIgnoreEmptyTokens(true).getTokenArray();
    ...
    public String extractPathWithinPattern(final String pattern,
            final String path) {
        final String[] patternParts = new StringTokenizer(pattern, pathSeparator)
                .setIgnoreEmptyTokens(true).getTokenArray();
        final String[] pathParts = new StringTokenizer(path, pathSeparator)
                .setIgnoreEmptyTokens(true).getTokenArray();
